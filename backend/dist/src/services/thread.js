...
var thread_1 = require("../validators/thread");
...
function create(dto, userId) {
    return __awaiter(this, void 0, void 0, function () {
        var validate, upload, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    validate = thread_1.createThreadSchema.validate(dto);
                    if (validate.error) {
                    ...
                    return [4 /*yield*/, cloudinary_1.v2.uploader.upload(dto.image, {
                            upload_preset: "circle",
                        })];
                case 1:
                    upload = _a.sent();
                    return [4 /*yield*/, prisma.thread.create({
                            data: __assign(__assign({}, dto), { userId: userId, image: upload.secure_url }),
                        })];
                case 2: return [2 /*return*/, _a.sent()];
                case 3:
                    error_3 = _a.sent();
                    throw new String(error_3);
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, prisma.thread.update({
                            where: { id: Number(id) },
                            data: __assign({}, thread),
                        })];
                case 2: return [2 /*return*/, _a.sent()];
                case 3:
                    error_4 = _a.sent();
                    throw new String(error_4);
                case 4: return [2 /*return*/];
            }
        });
    });
